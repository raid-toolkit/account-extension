...
public class StaticTypesExtension :
	...
	IAccountPublicApi<IGetAccountDataApi<StaticArtifactData>>, IGetAccountDataApi<StaticArtifactData>,
	IAccountPublicApi<IGetAccountDataApi<StaticHeroTypeData>>, IGetAccountDataApi<StaticHeroTypeData>,
	IAccountPublicApi<IGetAccountDataApi<StaticSkillData>>, IGetAccountDataApi<StaticSkillData>,
	IAccountPublicApi<IGetAccountDataApi<StaticLocalizationData>>, IGetAccountDataApi<StaticLocalizationData>,
	IAccountPublicApi<IGetAccountDataApi<StaticArenaData>>, IGetAccountDataApi<StaticArenaData>,
	IAccountPublicApi<IGetAccountDataApi<StaticAcademyData>>, IGetAccountDataApi<StaticAcademyData>,
	IAccountPublicApi<IGetAccountDataApi<StaticStageData>>, IGetAccountDataApi<StaticStageData>
{
	...
	bool IGetAccountDataApi<StaticArtifactData>.TryGetData([NotNullWhen(true)] out StaticArtifactData? data)
	...
	bool IGetAccountDataApi<StaticHeroTypeData>.TryGetData([NotNullWhen(true)] out StaticHeroTypeData? data)
	...
	bool IGetAccountDataApi<StaticSkillData>.TryGetData([NotNullWhen(true)] out StaticSkillData? data)
	...
	bool IGetAccountDataApi<StaticLocalizationData>.TryGetData([NotNullWhen(true)] out StaticLocalizationData? data)
	...
	bool IGetAccountDataApi<StaticArenaData>.TryGetData([NotNullWhen(true)] out StaticArenaData? data)
	...
	bool IGetAccountDataApi<StaticAcademyData>.TryGetData([NotNullWhen(true)] out StaticAcademyData? data)
	...
	bool IGetAccountDataApi<StaticStageData>.TryGetData([NotNullWhen(true)] out StaticStageData? data)
